...
from core.profile_utils import upsert_profile, delete_profile, get_profile
...
def handle_upsert_profile(event: Dict[str, Any], user_id: str, profile_id: str) -> Dict[str, Any]:
    """
