...
class HostingServiceBuilder(ServiceBuilder):
    ...
    def check_frontend_prerequisites(self):
        ...
        if not node_modules.exists():
            print("⚠️  node_modules not found. Run 'npm install' in frontend directory first.")
    ...
    def invalidate_cloudfront_cache(self):
        ...
        try:
            ...
            if "cloudfront" in stack_outputs:
                distribution_id = stack_outputs["cloudfront"].get("CloudFrontDistributionId")
                if distribution_id:
                ...
                print("⚠️  CloudFront stack outputs not found, skipping cache invalidation")
